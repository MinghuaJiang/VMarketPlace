...
import edu.virginia.cs.vmarketplace.service.login.AppUserEnrichStrategy;
import edu.virginia.cs.vmarketplace.service.login.CognitoPoolEnrichStrategy;
import edu.virginia.cs.vmarketplace.service.login.FacebookEnrichStrategy;
import edu.virginia.cs.vmarketplace.service.login.GoogleEnrichStrategy;

public class CustomizedSignInUI implements AWSConfigurable {
