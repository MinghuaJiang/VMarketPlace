...
import edu.virginia.cs.vmarketplace.view.Application;
...
public class PushListenerService extends GcmListenerService {
    ...
    public void onMessageReceived(final String from, final Bundle data) {
        ...
        NotificationClient.CampaignPushResult pushResult = notificationClient.handleCampaignPush( NotificationDetails.builder().from(from).bundle(data).serviceClass(this.getClass()).build());
